...
@REM start "" "%KBE_BIN_PATH%/kbcmd.exe" --clientsdk=unity --outpath="%~dp0/kbengine_unity3d_plugins"
@REM start "" "%KBE_BIN_PATH%/kbcmd.exe" --clientsdk=ue5 --outpath="%~dp0/kbengine_ue5_plugins"
